...
fig_chi_bmi_y_scale <- function() {
  fig_y_scale(14, 28)
}

fig_adu_bmi_y_scale <- function() {
  fig_y_scale(15, 40)
}

fig_chi_ovo_y_scale <- function() {
  fig_y_scale(0, 0.75, 0.15)
}

fig_adu_ovo_y_scale <- function() {
  fig_y_scale(0, 1, 0.2)
}

fig_sei_scale <- function() {
  col_pal <- c("red","gold","springgreen4","cornflowerblue","darkblue")
...
ggsave(
  filename = "fig/supp_fig_chi_bmi.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
ggsave(
  filename = "fig/supp_fig_chi_ovo.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
df_preds <- arrow::read_parquet("res/mod_adu_bmi_sei_preds.parquet")
...
boot_df_preds <- arrow::read_parquet("res/mod_adu_bmi_sei_boot_preds.parquet")
...
ggsave(
  plot = prs_sei_plot,
  filename = "fig/supp_fig_adu_bmi_prs_sei.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
df_preds <- arrow::read_parquet("res/mod_adu_bmi_sep_preds.parquet")
...
boot_df_preds <- arrow::read_parquet("res/mod_adu_bmi_sep_boot_preds.parquet")
...
boot_df_ci <-
  ...
  summarise(
    n_boot = n(), 
    med_p = median(pred_p), 
    lo_p = quantile(pred_p, alpha / 2, na.rm = TRUE), 
    up_p = quantile(pred_p, 1 - alpha / 2, na.rm = TRUE), 
    .groups = "drop"
  ) %>%
  arrange(sep, prs, age_cat)
...
ggsave(
  plot = prs_sep_plot,
  filename = "fig/supp_fig_adu_bmi_prs_sep.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
df_preds_sei <- arrow::read_parquet("res/mod_adu_bmi_sei_preds.parquet")
...
boot_df_preds_sei <- arrow::read_parquet("res/mod_adu_bmi_sei_boot_preds.parquet")
...
df_preds_sep <- arrow::read_parquet("res/mod_adu_bmi_sep_preds.parquet")
...
boot_df_preds_sep <- arrow::read_parquet("res/mod_adu_bmi_sep_boot_preds.parquet")
...
ggsave(
  filename = "fig/supp_fig_adu_bmi.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
df_preds <- arrow::read_parquet("res/mod_adu_ovo_sei_preds.parquet")
...
boot_df_preds <- arrow::read_parquet("res/mod_adu_ovo_sei_boot_preds.parquet")
...
ggsave(
  plot = prs_sei_plot,
  filename = "fig/supp_fig_adu_ovo_prs_sei.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
df_preds <- arrow::read_parquet("res/mod_adu_ovo_sep_preds.parquet")
...
boot_df_preds <- arrow::read_parquet("res/mod_adu_ovo_sep_boot_preds.parquet")
...
ggsave(
  plot = prs_sep_plot,
  filename = "fig/supp_fig_adu_ovo_prs_sep.png",
  width = 12,
  height = 7,
  dpi = 300
)
...
df_preds_sei <- arrow::read_parquet("res/mod_adu_ovo_sei_preds.parquet")
...
boot_df_preds_sei <- arrow::read_parquet("res/mod_adu_ovo_sei_boot_preds.parquet")
...
df_preds_sep <- arrow::read_parquet("res/mod_adu_ovo_sep_preds.parquet")
...
boot_df_preds_sep <- arrow::read_parquet("res/mod_adu_ovo_sep_boot_preds.parquet")
...
ggsave(
  filename = "fig/supp_fig_adu_ovo.png",
  width = 12,
  height = 7,
  dpi = 300
)
