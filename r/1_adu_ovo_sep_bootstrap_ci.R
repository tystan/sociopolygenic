...
sink("res/mod_adu_ovo_sep.txt")
  ...
  print_mod_results(mod_adu_ovo_sep)
...
arrow::write_parquet(df_preds, sink = "res/mod_adu_ovo_sep_preds.parquet")
...
arrow::write_parquet(boot_df_preds, sink = "res/mod_adu_ovo_sep_boot_preds.parquet")
