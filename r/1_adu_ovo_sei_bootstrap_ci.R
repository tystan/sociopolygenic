...
sink("res/mod_adu_ovo_sei.txt")
  ...
  print_mod_results(mod_adu_ovo_sei)
...
arrow::write_parquet(df_preds, sink = "res/mod_adu_ovo_sei_preds.parquet")
...
arrow::write_parquet(boot_df_preds, sink = "res/mod_adu_ovo_sei_boot_preds.parquet")
